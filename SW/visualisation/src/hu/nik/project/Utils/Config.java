...
public class Config {
    ...
    public static String pathMap1 = "src/hu/nik/resources/maps/road_1.png";
    public static String pathMap2 = "src/hu/nik/resources/maps/road_2.png";

    public static String pathCar = "src/hu/nik/resources/entities/Car2.png";
